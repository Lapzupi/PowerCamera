...
public class CameraRunnableView extends BukkitRunnable {
    private int ticks = 0;
    ...
    public CameraRunnableView(final PowerCamera plugin, final Player player, final @NotNull Camera camera) {
        this.plugin = plugin;
        this.player = player;
        this.camera = camera;
    ...
    public CameraRunnableView start() {
    ...
    public CameraRunnableView preview(Player player, int num, int previewTime) {
